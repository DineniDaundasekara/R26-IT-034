...
JSON_RESULT_FILE = "../models/random_forest_result.json"
...
print(f"{'Random Forest':<25} {round(float(accuracy), 4):<10} {round(float(precision), 4):<10} {round(float(recall), 4):<10} {round(float(f1), 4):<10}")
